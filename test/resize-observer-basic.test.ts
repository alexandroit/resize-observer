...
describe('Basics', (): void => {
  ...
  test('Throw error when no callback is passed to constructor', (): void => {
    ...
    expect(fn).toThrow(`Failed to construct 'ResizeObserver': 1 argument required, but only 0 present.`);
  })
  ...
  test('Throw error when an invalid callback is passed to constructor', (): void => {
    ...
    expect(fn).toThrow(`Failed to construct 'ResizeObserver': The callback provided as parameter 1 is not a function.`);
  })
  ...
  test('Throw error when no target is passed to observe()', (): void => {
    ...
    expect(fn).toThrow(`Failed to execute 'observe' on 'ResizeObserver': 1 argument required, but only 0 present.`);
  })
  ...
  test('Throw error when an invalid target is passed to observe()', (): void => {
    ...
    expect(fn).toThrow(`Failed to execute 'observe' on 'ResizeObserver': parameter 1 is not of type 'Element`);
  })
  ...
  test('Throw error when no target is passed to unobserve()', (): void => {
    ...
    expect(fn).toThrow(`Failed to execute 'unobserve' on 'ResizeObserver': 1 argument required, but only 0 present.`);
  })
  ...
  test('Throw error when an invalid target is passed to unobserve()', (): void => {
    ...
    expect(fn).toThrow(`Failed to execute 'unobserve' on 'ResizeObserver': parameter 1 is not of type 'Element`);
  })
